...
{
    IMAGE_INFO_LINUX_VERSION_INVALID, ///< Invalid image info version
...
struct /*<UTILITY>*/ IMAGE_INFO_LINUX
{
    ...
    IMAGE_INFO_LINUX()
        : _version(IMAGE_INFO_LINUX_VERSION_0), _type(IMAGE_TYPE_LINUX_INVALID), _name(""), _offset(0), _lm(0), _l_ld(0)
    {}
};
